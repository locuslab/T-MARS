...
from dataset2metadata.text_detection.mmocr.apis.inferencers import MMOCRInferencer
from dataset2metadata.text_detection.mmocr.apis.inferencers.base_mmocr_inferencer import InputsType
from dataset2metadata.text_detection.mmocr.utils import register_all_modules
...
class MMOCR:
    ...
    def readtext(self,
        ...
        # img = ['demo/demo_text_ocr.jpg']
        # img = ['/home/sachingo/mmocr/demo/demo_text_ocr.jpg']
